...
class EnsembleDataset(Dataset):
    cls_weight = [1. for tissue in OrganType + CancerType]
    def __init__(self, 
    ...
    def __getitem__(self, idx):
        ...
        item["mask"] = rearrange(one_hot(item["mask"].long(), len(self.cls_weight)), "1 h w d n -> n h w d")
...
def save_text_features(save_dir="/ailab/user/dailinrui/data/dependency/",
    ...
    from ddpm.models.encoder import FrozenBERTEmbedder
