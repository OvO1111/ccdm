...
from train.utils import instantiate_from_config, BasicLogger


class Txt2ImgIterableBaseDataset:
    ...
...
class ImageLogger(Callback):
    def __init__(self, train_batch_frequency, val_batch_frequency, max_images,
        ...
        self.batch_freq_val = val_batch_frequency
    ...
    def log_local(self, save_dir, split, images, global_step, current_epoch, batch_idx):
        ...
        self._maybe_mkdir(os.path.dirname(path))
        local_image = BasicLogger._image_logger(images, path)
    ...
    def log_img(self, pl_module, batch, batch_idx, split="train"):
        ...
        if (self.check_frequency(check_idx, split) and  # batch_idx % self.batch_freq == 0
                hasattr(pl_module, "log_images_train") and
                self.max_images > 0):
